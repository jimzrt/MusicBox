...
template <class CALLBACK_T> class NeoPatterns : public Adafruit_NeoPixel
{
    public:
   ...
   // void (*OnComplete)();  // Callback on completion of pattern
    CALLBACK_T& callbackObject;
    
    // Constructor - calls base-class constructor to initialize strip
    NeoPatterns(uint16_t pixels, uint8_t pin, uint8_t type, CALLBACK_T& callbackObject)
    :Adafruit_NeoPixel(pixels, pin, type), callbackObject(callbackObject)
    {
    }
